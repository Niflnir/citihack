        ...
        <div className="main-container">
          <div className="sidebar">
            ...
            <div className="inputs">
              <FormControl>
                ...
                <RadioGroup row value={risk} onChange={(e) => setRisk(parseInt(e.target.value))}>
                  <FormControlLabel
                    style={{ margin: "0px" }}
                    value={0}
                    control={<Radio />}
            ...
            <div className="inputs">
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label="Stocks to filter by" placeholder="Google" />
                )}
              />
            </div>
            <div className="inputs">
          ...
          <div className="portfolios">
            {filteredPortfolio.length !== 0 ? (
              filteredPortfolio
                .sort(compare)
                .map((info, index) => <PortfolioCard key={index} info={info} />)
            ) : (
